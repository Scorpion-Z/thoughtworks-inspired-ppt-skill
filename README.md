...
一个适配 Codex、Claude Code、Cursor 等 Agent 环境的 HTML PPT Skill，用于生成 Thoughtworks-inspired 风格的网页演示文稿、结构图、路线图、能力框架图和汇报型封面。
...
- 生成后对照 `references/quality.md` 自检。
...
7. 可选配图：按 `references/image-guide.md` 生成或重画图例。
8. 质量自检：执行 `references/quality.md`。
